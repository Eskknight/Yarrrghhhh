var lan_lockout = {
    "announcement_header": "<strong>SKETCHBOOK</strong>",
    "announcement_middle": "免费",
    "no_really": "太棒了！",
    "announcement_footer": "您所需的只是一个 Autodesk 帐户",

    "create_account_button": "创建帐户",
    "login_button": "登录",

    // "days_remaining_plural_txt": "或者，在没有帐户的情况下，体验 <span id='remaining_days'>7</span> 天",
    "days_remaining_plural_txt_1": "或者，在没有帐户的情况下，体验",
    "days_remaining_plural_txt_2": "天",
    "days_remaining_singular_txt": "或者，在没有帐户的情况下，体验 1 天",

    "start_now_link": "开始绘制",

    // "enjoy_trial_header_plural_txt": "在没有帐户的情况下，畅享 <strong>SketchBook</strong> 7 天",
    "enjoy_trial_header_plural_txt_1": "在没有帐户的情况下，畅享 <strong>SketchBook</strong> ",
    "enjoy_trial_header_plural_txt_2": "天",
    "enjoy_trial_header_singular_txt": "在没有帐户的情况下，畅享 <strong>SketchBook</strong> 1 天",

    "calendar_icon_header": "剩余天数",

    // "enjoy_trial_footer": "或者，简单地创建一个<a>免费帐户</a>",
    "enjoy_trial_footer_label": "或者，简单地创建一个",
    "enjoy_trial_footer_link": "免费帐户"
};
...
// SIG // XYnz0/LkGi30BNhddWjwfWuxJSmP1o9AQFFKpL5c5uyg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgovUtOYFC
// SIG // wanmJeVpIPh9HhL0k2ohuhMWk3Fyn98b7pswDQYJKoZI
// SIG // hvcNAQEBBQAEggEANBgXrNmSFh4L+ayCtc6bDZU18zR8
// SIG // DHcgObgObFHiDHM7iY2lEx0M1nx6mRu88chTPnDZ3ij0
// SIG // IDJCQX7Ih1gWuywN2k87jSHOchiNUS7/Y5GG33Si1y5I
// SIG // DMZQY1/VycviCahy5NPsNTaV9Wct/cVMlQFsOdEewvvF
// SIG // MldPF6nzReKGuPYO890dyaGkbNCq1WN6uld+jAAXAPe2
// SIG // nOaCfHqPiZoTYrGftFSXW/8fbvkqaF+SgC4ggxe3wzCF
// SIG // MJvcKgR9ies9jQtSuDv+V6ZhkhQatYx0uMjIAJGLrpI3
// SIG // mKD6n+jlRfYDkoO1OavTL6U2U3w7DqsjZKg5nLG6Zr/v
// SIG // pyFWIaGCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIL2h
// SIG // KfmIYzQJNJEZYa/FedGX7fVBL7NyyRgC17NJ7ahYAhQ5
// SIG // b6XJIgOanN/Tt8c2YDSEmZNjbxgPMjAxOTExMTIxODQz
// SIG // NTVaMAMCAR6ggYakgYMwgYAxCzAJBgNVBAYTAlVTMR0w
...
// SIG // ODQzNTVaMC8GCSqGSIb3DQEJBDEiBCAP/xUjWaNsnfz+
// SIG // sutD0NQyGaBvM1rFh/d/f7vvtr3u/zA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEAkQ5u
// SIG // ujcov7kM2kGHxEMVRk6xBWUZ1NgKybpQ75l0cbB24+c3
// SIG // lrbmR9wr9HWwO1UOs4Xnbljeu1QVDnAjnsGK+SX5QJI3
// SIG // NNTWcnejD+ms98cPfrChQKvgxX+jy/MhZKGwZ390wWQK
// SIG // TffQM/dwIPUH0/bA/gXPcvrO/Qu35apLWx9DQV0j8D3A
// SIG // EdMp/EBCBw3aNFRu6B11RHnFQPntLfNdiW9IGPuZb5m4
// SIG // +79aHDmc5mqdzSDs9ZgVvrZG1PbWHTDpg3gZ+vOP4hCK
// SIG // 484K07d13vXtdhvTW/H1NIvGKvaoRsnSU5HF91N0jayb
// SIG // mYl8LApgTV8/loqApTA2re1G8n0AQA==
