var lan_subscription = {
    "about_subscription_title": "A propos de l'abonnement",
    "about_subscription_10": "Quels sont les avantages d'un abonnement à SketchBook ?",
    "about_subscription_11": "Accès aux outils avancés dans SketchBook. Obtention de toutes les mises à jour et des nouvelles fonctionnalités sur l'ensemble de vos périphériques. Création d'un nombre illimité de scènes dans SketchBook Motion.",
    "about_subscription_20": "Comment puis-je accéder à mon abonnement sur d'autres périphériques ?",
    "about_subscription_21": "Connectez-vous avec le nom d'utilisateur et le mot de passe Autodesk que vous avez utilisés lors de l'achat de votre abonnement.",
    "about_subscription_30": "Quand mon abonnement sera-t-il renouvelé ?",
    "about_subscription_31": "Les abonnements sont renouvelés automatiquement, sauf si le renouvellement automatique est désactivé au moins 24 heures avant la fin de la période d'abonnement en cours.",
    "about_subscription_40": "Quand serai-je débité ?",
    "about_subscription_41": "Votre compte sera débité du montant du renouvellement dans les 24 heures précédant la fin de la période d'abonnement en cours, et il indiquera le coût du renouvellement.",
    "about_subscription_50": "Comment annuler mon abonnement ?",
    "about_subscription_51": "Une fois votre achat terminé, vous pouvez gérer votre abonnement, ainsi que votre renouvellement automatique, dans les paramètres de votre compte.",
    "about_subscription_60": "Vais-je perdre mes données si je me désabonne ?",
    "about_subscription_61": "Non. Vous aurez toujours accès à l'ensemble de vos fichiers et aux outils de base gratuits. En revanche, sachez que la suppression de l'application supprimera l'ensemble de vos fichiers.",
    "about_subscription_90": "Conditions d'utilisation d'A360",
    "about_subscription_91": "et",
    "about_subscription_92": "Politique de confidentialité d'Autodesk",

	// price period
	"price_year_txt": " / an",
	"price_month_txt": " / mois",

	//promotion buy button
	"promotion_info_title_sale": "VENTE",
	"promotion_info_detail_off_percent": "remise de {0}%",
	"promotion_info_detail_free_months": "obtenir {0} mois gratuits",
	"promotion_info_detail_free_month": "obtenir 1 mois gratuit",

	"promotion_daysleft": "<span style='color: #188dfb'>{0}</span> jours restants",
	"promotion_dayleft": "<span style='color: #188dfb'>1</span> jour restant",

	"promotion_dropdown_extension_months": "+ {0} mois",
	"promotion_dropdown_extension_month": "+ 1 mois",
}
...
// SIG // Wkhwiybh9mBl3QAlh7GZHU9CLcjtn8q3d5LaAuO9xsqg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgyr8HBHxJ
// SIG // xFTMYviEHWnXxx7Pej+CapxLfimwqwFVNlYwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAcMycZp0IekSXPX8/Mwo6Syh7UZNI
// SIG // q0KubZTYK8mJeMbh4vN/b2lLDuDhGxm5IieLBW7U9SoQ
// SIG // 3BamnrdeUQ/WILXj3F2S7i7MtRiZBOwo80hmURykCJxd
// SIG // MkNu2Ykd3c2sNof5RGajTO9YaoTIvwmgVxhz5wZibiuk
