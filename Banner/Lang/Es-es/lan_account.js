var lan_account = {
	"tag_1_txt": "Mi perfil",
	"tag_2_txt":"Mis recursos creativos",
	"tag_3_txt" : "Mi plan",
	"account-login-out": "Cerrar sesión",
	"greeting_txt": "Hola, ",
	"account_title_email": "Correo electrónico",
	"edit_btn": "Administrar cuenta en línea",
	"account_title_membership":"Suscripción",
	"MEMBERSHIP_PRO_TRIAL": "Suscripción a SketchBook Pro (Prueba)",
	"MEMBERSHIP_PRO_CAMPAIGN": "Suscripción a SketchBook Pro (Campaña)",
	"MEMBERSHIP_PRO": "Suscripción a SketchBook Pro",
	"MEMBERSHIP_FREE": "GRATIS",
	"MEMBERSHIP_PRO_MONTH": "Suscripción a SketchBook Pro (Mensual)",
	"MEMBERSHIP_PRO_YEAR": "Suscripción a SketchBook Pro (Anual)",
	"MEMBERSHIP_PRO_QUARTERLY": "Suscripción a SketchBook Pro (Trimestral)",
	"account_title_validatedate": "Válido hasta",
	"account_intro_free_id": "GRATIS: acceso a las herramientas básicas para bocetos rápidos.",
	"free_feature_list_1":"Flujo de trabajo optimizado con lápiz",
	"free_feature_list_2":"16 pinceles " ,
	"free_feature_list_3":"3 capas",
	"free_feature_list_4":"Reglas y elipses",
	"free_feature_list_5":"Transformación rápida",
	"left_current_plan": "Plan actual",
	"account_intro_pro_id":"PRO: obtenga la experiencia completa de SketchBook en todos los dispositivos favoritos.",
	"pro_feature_list_1":"Más de 100 pinceles personalizables",
	"pro_feature_list_2":"Función avanzada de capa",
	"pro_feature_list_3":"Conjunto completo de colores Copic",
	"pro_feature_list_4":"Animación FlipBook",
	"pro_feature_list_5":"Guías de perspectiva avanzadas",
	"pro_feature_list_6":"Herramientas de selección permanente",
	"pro_feature_list_7":"Deformación",
	"pro_feature_list_8":"Relleno de degradado dinámico",
	"pro_feature_list_9":"Desbloqueo en dispositivos móviles y de escritorio",
	"pro_feature_list_10":"Sin límite de actualizaciones",
	"account_learn_more":"Más información",
	"right_current_plan": "Plan actual",
	"account_expire_txt": "Válido hasta",
	"account_activate_trial_btn_txt": "Prueba de 15 días",
	"account_activate_trial_btn_txt_0": "Prueba de",
	"account_activate_trial_btn_txt_2": "días",
	"countdown_txt_part1_1": "Días restantes",
	"countdown_txt_part1_2": "Día restante",
	"countdown_fortrial": "para la prueba",
	"account_price_cell_txt": "Comprar",

	"trial_activated_header": "Versión de prueba activada.",
	"trial_activated_failed_header":"La versión de prueba no se ha activado.",
	"trial_activated_txt":"Ahora puede disfrutar de una suscripción Pro gratis durante 15 días.",
	"trial_validated_success_txt_1": "Ahora puede disfrutar de una suscripción Pro gratis durante",
	"trial_validated_success_txt_2": "días.",
	"trial_not_activated_same_machine_txt":"Este equipo ya ha ejecutado la versión de prueba.",
	"trial_not_activated_expired_txt":"La prueba de su cuenta ha caducado.",
	"trial_not_activated_try_again_txt":"Inténtelo de nuevo.",
	"ok_btn":"Aceptar",

	"forjs_mo": " / mes",
	"forjs_yr": " / año",

	"account_mas_trial_btn_txt": "Prueba gratuita de 7 días",
	"account_mas_buy_btn_txt": "Comprar",

    //title
    "price-title-free": "Gratis",
    "price-title-pro": "Pro",

    //trial txt
    "account_countdown_txt_1": "Días restantes de la prueba gratuita",
    "account_countdown_txt_2": "Día restante de la prueba gratuita",
}
...
// SIG // 1XZxrR2zYfv2PIUJZAvyaFiRa5w8rFS/zFc5RotjlHSg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgIJ9hZdlh
// SIG // nUIpPsI7ZD8ijoqUTUguyeaQM37USiY02cMwDQYJKoZI
// SIG // hvcNAQEBBQAEggEANHgWbKm2PacLbkHuhdjNlq3WTQm8
// SIG // npqhJrkPGMTpe/zhWMDnYT20ypiMwW1KIJvP1Rbvq8Xx
// SIG // 4foEpdNh3Yix8MsbWCb8brhB8ZD3ZAEkB1gGSyHttMwz
// SIG // zcvxhHySSH/KPcIrVvBzsLOaB/DKArKGwlZGomVImzWz
// SIG // 5T39Tfk8DTRPPQgsPeUCDBMv46mCy7p9MEOmMwXWxah0
// SIG // 4uUYRi1aOIB7vui85o7sHoswvg/F4V/OZfTsr1ktFF0m
// SIG // LryzKcYsyJyLH1BT+0SZTEIpGJRKlLMiFqom2Hj9b0XF
// SIG // yxHjVJMtR7rAaBhKkMiKAlmMLVKiB5g5z7jmnvPQ1hNG
// SIG // 3Z/cF6GCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIKP/
// SIG // SjgIxsEJU9Hq6eXtaBOFgDl+C0kqQrqceRcVOGg3AhQ4
// SIG // VUnKGDF7soCtfi1AsWB4IXP2FRgPMjAxOTExMTIxODQz
// SIG // MzhaMAMCAR6ggYakgYMwgYAxCzAJBgNVBAYTAlVTMR0w
...
// SIG // ODQzMzhaMC8GCSqGSIb3DQEJBDEiBCD5V2oe66gnjCCR
// SIG // U2NhyUdpOXk51g24hBZIW3uQGeG1uDA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEAkg/G
// SIG // txmlTZl4moN8d5IaRFPrrGtDIVbXK7CKF6GTh7ODK1FU
// SIG // K+hI8hA1YqfNjdLJMAxJTee7D0Ed91OieKJ94HlKdHAg
// SIG // Dx4vXJh0G2AnQN37jSSiCFM7/HSFq0kerzUztYvY9s99
// SIG // NPcIejPTbJvZr9H9F62yBpdl4uxGkG10SGWM9GOTYmf/
// SIG // ebIdK4EFBKndFnW29MIBXe2jsDm9ftByX0nWTls5goro
// SIG // VSM4d1UqoBJZO+Lf8QzdqjV9AHmeiMpj3Us5DH0UxdMv
// SIG // heNZwX0uOm95z80Sckn5zgeeYev6P8Z64v66yRxfDR76
// SIG // lJPl9qLPipcDCsYyHEnS/blFy5LSSQ==
