var lan_account = {
	"tag_1_txt": "Mein Profil",
	"tag_2_txt":"Meine kreativen Objekte",
	"tag_3_txt" : "Mein Plan",
	"account-login-out": "Abmelden",
	"greeting_txt": "Hallo, ",
	"account_title_email": "E-Mail",
	"edit_btn": "Konto online verwalten",
	"account_title_membership":"Mitgliedschaft",
	"MEMBERSHIP_PRO_TRIAL": "SketchBook Pro-Mitgliedschaft (Testversion)",
	"MEMBERSHIP_PRO_CAMPAIGN": "SketchBook Pro-Mitgliedschaft (Kampagne)",
	"MEMBERSHIP_PRO": "SketchBook Pro-Mitgliedschaft",
	"MEMBERSHIP_FREE": "KOSTENLOS",
	"MEMBERSHIP_PRO_MONTH": "SketchBook Pro-Mitgliedschaft (Monatlich)",
	"MEMBERSHIP_PRO_YEAR": "SketchBook Pro-Mitgliedschaft (Jährlich)",
	"MEMBERSHIP_PRO_QUARTERLY": "SketchBook Pro-Mitgliedschaft (Vierteljährlich)",
	"account_title_validatedate": "Gültig bis",
	"account_intro_free_id": "KOSTENLOS: Zugriff auf grundlegende Werkzeuge für schnelle Skizzen.",
	"free_feature_list_1":"Optimierter stiftbasierter Workflow",
	"free_feature_list_2":"16 Pinsel " ,
	"free_feature_list_3":"3 Layer",
	"free_feature_list_4":"Lineale und Ellipsen",
	"free_feature_list_5":"Schnelltransformation",
	"left_current_plan": "Aktueller Plan",
	"account_intro_pro_id":"PRO: Holen Sie sich das ganze SketchBook-Erlebnis auf all Ihre bevorzugten Geräte.",
	"pro_feature_list_1":"Über 100 anpassbare Pinsel",
	"pro_feature_list_2":"Erweiterte Layer-Funktion",
	"pro_feature_list_3":"Vollständige Copic-Farben",
	"pro_feature_list_4":"Daumenkinoanimation",
	"pro_feature_list_5":"Erweiterte Perspektiven-Hilfslinien",
	"pro_feature_list_6":"Permanente Auswahlwerkzeuge",
	"pro_feature_list_7":"Verzerren, Transformieren",
	"pro_feature_list_8":"Dynamische Abstufungsfüllung",
	"pro_feature_list_9":"Mobiles Endgerät und Desktop entsperren",
	"pro_feature_list_10":"Unbegrenzte Upgrades",
	"account_learn_more":"Erfahren Sie mehr",
	"right_current_plan": "Aktueller Plan",
	"account_expire_txt": "Gültig bis",
	"account_activate_trial_btn_txt": "15 Tage Testversion",
	"account_activate_trial_btn_txt_0": "",
	"account_activate_trial_btn_txt_2": "Tage Testversion",
	"countdown_txt_part1_1": "Tage noch",
	"countdown_txt_part1_2": "Tag noch",
	"countdown_fortrial": "als Testversion",
	"account_price_cell_txt": "Kaufen",

	"trial_activated_header": "Testversion aktiviert!",
	"trial_activated_failed_header":"Testversion nicht aktiviert!",
	"trial_activated_txt":"Sie können jetzt eine PRO-Mitgliedschaft kostenlos 15 Tage lang probieren.",
	"trial_validated_success_txt_1": "Sie können jetzt eine PRO-Mitgliedschaft kostenlos",
	"trial_validated_success_txt_2": "Tage lang probieren.",
	"trial_not_activated_same_machine_txt":"Auf diesem Computer wurde bereits die Testversion ausgeführt.",
	"trial_not_activated_expired_txt":"Die Testversion für Ihr Konto ist abgelaufen.",
	"trial_not_activated_try_again_txt":"Bitte versuchen Sie es erneut.",
	"ok_btn":"OK",

	"forjs_mo": " / Monat",
	"forjs_yr": " / Jahr",

	"account_mas_trial_btn_txt": "7 Tage kostenlose Test",
	"account_mas_buy_btn_txt": "Kaufen",

    //title
    "price-title-free": "Kostenlos",
    "price-title-pro": "Pro",

    //trial txt
    "account_countdown_txt_1": "Tage verbleiben für die Testversion",
    "account_countdown_txt_2": "Tag verbleibt für die Testversion",
}
...
// SIG // yviEGhqiqsShxN9X9qcdg5N71Bi/dnsNKU5FCSustEug
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrsqmearm
// SIG // dqAMv57w8tvQ80UKw4qtU2FwbMNWX/2KlBAwDQYJKoZI
// SIG // hvcNAQEBBQAEggEABJsS+6O3r2lA+SOp5o361Y1olLcp
// SIG // +ENgHXVzepdK7Lh4Er3vjWl3ygGsWhSRAZ7hl3LdLiFC
// SIG // 224ZjxvrsVKFTS5D63e8opbWc+rtlKMuNxp/K/AwSM0O
// SIG // 1Ul03Y34RvJpNsTGiC/WaOWqwTL7CT0oqqg0xMhtKi0i
// SIG // Vtg/aawfPESYBrLcMhVJ4xunqQdS7B9evwYup8foQTCZ
// SIG // g7oMwrYw9g5AnfSjAf/pxIkrMHSOxicBP8+8FJWiqgAm
// SIG // ScYp4iknosEY7BVRx12HuGN7ZXb3a2EE9+jMN4yX+EpE
// SIG // 9pOpRJ//UCcf9DQsKIsaqIAIIZXnvyDeJrncTu6c55MY
// SIG // WzNXHqGCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIIss
// SIG // xaUnNZiDkHFA2VqgT+EPvVh0YXBr7O9GnMlKW72CAhRr
// SIG // WU2NeWmpqh9lHCqvQelrEnmWPxgPMjAxOTExMTIxODQ0
...
// SIG // ODQ0MzhaMC8GCSqGSIb3DQEJBDEiBCBIJK6lrGfZpHju
// SIG // u6bWBW/4fqCCN0QgKqDHRPdpGZNvRzA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEAHiHX
// SIG // 6pah5s70e5DJ0Ypcrkm5BpzWNM7EpB4QiyxRvjasZD3T
// SIG // LqDntibviiLTiAfhq4HFylQLeTO8SPIHgaI5fkUbOrYM
// SIG // qr94rlHPQFotQa+y5aYMjKishoA/q3cm5N0/BDsML1eA
// SIG // XtgkNASJzqSPluG7a2dbDPlCjptDMZyg4thiZ1eIT+1U
// SIG // cKx55kYfHyqwpLKQpYUPaOk8ya/eWOa8xALvlhqagNC4
// SIG // EE5ewF65eh0d+K3Z1U5VMz57G/mezAVm7ZRnpTfmvtp+
// SIG // rlI+EuVX0NoAzakCPMteO49ivhg9v+wn5T4+XMX5eCtY
// SIG // 6kNRzdWOrr8ORXzydY7tOf2kKaU8Bg==
