var lan_campaign_validated = {
	"campaign_validated_success_header": "Поздравляем!",
	"campaign_validated_failed_header": "Сбой при активации.",
	"campaign_validated_failed_involved_header": "Сбой при активации.",
	"campaign_validated_failed_error_header": "Произошла ошибка",
	// "campaign_validated_success_txt": "Enjoy your Pro membership for <span id='campaign_days'>30</span> days.",
	"campaign_validated_success_txt_1": "Преимущества подписки Pro доступны в течение",
	"campaign_validated_success_txt_2": "дн.",
	"campaign_validated_success_singular_txt_1": "Преимущества подписки Pro доступны в течение",
	"campaign_validated_success_singular_txt_2": "дня.",
	// "campaign_validated_success_singular_txt": "Enjoy your Pro membership for <span id='campaign_day'>1</span> day.",
	"campaign_validated_invalid_txt": "Срок действия этой акции истек.",
	"campaign_validated_consumed_txt": "Ознакомительная версия подписки Pro уже используется, поэтому данная акция недоступна.",
	"campaign_validated_maxtimes_txt": "Эта акция завершена.",
	"campaign_validated_client_error_txt": "Повторите попытку.",
	"campaign_validated_unknown_txt": "Повторите попытку.",
	"ok_btn": "OK"
}
...
// SIG // ufYQsgqfsboDgq2Yi9sheTgJT2naY1cD2PyrjuaEUzyg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg2R/7Jg3a
// SIG // 7w+sREgfXalcBqcW7BZU6x6cMOHRO37Df/gwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAirFaw13WYDtrlE1O96AXXBshpEhw
// SIG // Gx6/GRdsENpByN3jjnWLw18kyeYmDQ+AdpZ/DmS2nwxw
// SIG // x/T2HHS9xBSCdZ2RyhdpUaoMe8HeSvIqoFIBwzuya1GK
// SIG // qd4mQEPTnLOCRVYyoFh+7i0clIk3RUnpAjYXF4ZqUQjV
// SIG // uFmcv/7IC9EjxtnuquMxPNOq0pwAC+SyN6BwPoDwX9n8
// SIG // H878t3iUnpSuuhaIecZm0FYSAkSeFEdPGeYeDF5i29TO
// SIG // oxarwHPIbpndSfkf94aXrvX/y3aYfhJ2mD4laXF/P3Bm
// SIG // rC3I3j+JNFmGhlvNtavIMN57WP7MQnu2hK7rOaUgpnnV
// SIG // FZc1tqGCDHQwggxwBgorBgEEAYI3AwMBMYIMYDCCDFwG
// SIG // CSqGSIb3DQEHAqCCDE0wggxJAgEDMQ8wDQYJYIZIAWUD
// SIG // BAIBBQAwga8GCyqGSIb3DQEJEAEEoIGfBIGcMIGZAgEB
// SIG // BgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg1NDX
// SIG // A4qKQcJijmb2UgNSWIu3by5xYCPMin6RKCRgDpECFAS4
// SIG // fbkDzugpVTiDl5cs39O9Gib6GA8yMDE5MTExMjE4NDQx
...
// SIG // MTRaMC8GCSqGSIb3DQEJBDEiBCBqyteCxY+tjTJsGnvv
// SIG // aHfp7oc5lcKqHhnd3QMqQScFYjCBoAYLKoZIhvcNAQkQ
...
// SIG // ggEAAGXIUVIAc5VVnwFQsNnU9ywQ16tC9dCEsrP/cNTf
// SIG // J/96nWFAmeXsrrwzlFy1DLWw5+U4iFCZIrP4ZiBwkw5n
// SIG // +XCvciRexjCaqs33Eas6pICY3HA9CG0bW/19m+auH8vB
// SIG // W3tFDV/4GJI5kpugpWe7RZt58B47fcyMEpLldpJff5mD
// SIG // xrTgzJomS+h9/Opii0L6vFcWwsvWksaefIqB2mB2Jv4D
// SIG // V14LBNvQuGf0QYXm3evir6OhbGnDLB4bj8RTvcQ7rxYM
// SIG // F5z7VnXM+LmWSFdyxVeWVidV+7Qo+eiD0q3u0xwCw/l6
// SIG // 7/QtlTlHA1UMCv0IEXSgbyrch4RYA7SwjC7y5Q==
