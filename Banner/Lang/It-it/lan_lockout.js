var lan_lockout = {
    "announcement_header": "<strong>SKETCHBOOK</strong> adesso è",
    "announcement_middle": "gratis",
    "no_really": "no, davvero!",
    "announcement_footer": "Serve solo un Autodesk Account",

    "create_account_button": "Crea account",
    "login_button": "Accedi",

    // "days_remaining_plural_txt": "Oppure puoi utilizzarlo senza un account per <span id='remaining_days'>7</span> giorni",
    "days_remaining_plural_txt_1": "Oppure puoi utilizzarlo senza un account per",
    "days_remaining_plural_txt_2": "giorni",
    "days_remaining_singular_txt": "Oppure puoi utilizzarlo senza un account ancora per un giorno",

    "start_now_link": "Inizia a disegnare",

    // "enjoy_trial_header_plural_txt": "Utilizza <strong>SketchBook</strong> per altri 7 giorni senza un account",
    "enjoy_trial_header_plural_txt_1": "Utilizza <strong>SketchBook</strong> per altri",
    "enjoy_trial_header_plural_txt_2": "giorni senza un account",
    "enjoy_trial_header_singular_txt": "Utilizza <strong>SketchBook</strong> ancora per un giorno senza un account",

    "calendar_icon_header": "Giorni rimanenti",

    // "enjoy_trial_footer": "Oppure crea un <a>account gratuito</a>",
    "enjoy_trial_footer_label": "Oppure crea un",
    "enjoy_trial_footer_link": "account gratuito"
};
...
// SIG // e1v4+3tQQ2TWA8AF2ggBN2krLwgGywYyLqkP8dd3O2ig
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgEFZOp3ZX
// SIG // WLoENBcF9+z8GocNULoL9y+le5dHVWWlFx4wDQYJKoZI
// SIG // hvcNAQEBBQAEggEAJhs1VXPLv5DALwuMvdd9F/d7JP/+
// SIG // 2lIhei45Isuh5XNVwav4kuACxSBbafXJ7f1mvdqUFOaM
// SIG // sedsEt6f4JIhchq09VTJ/J2T7svd2whesWfXdhUuY1PU
// SIG // +gq6dJcJU3AiBRJqqqNpodGYBkic9uUtWLati9n5pBKh
// SIG // 3f40+3RDo6oVV/ii4rvKPpziHS9XcRq2KrwULkMO3h93
// SIG // rqzyGkDj5/x/hqvAvq/Y0fl+lhG2llaCIE2xHVir0DTp
// SIG // v/mRkZ6ostYsiemd9zpUxp2BgIsnOLKowJV5VJbYaRrz
// SIG // Ag/WpXVeVJOqvsUgjC97QeYA5+xmcP6prb7HfWacO0vr
// SIG // wJQsqKGCDj0wgg45BgorBgEEAYI3AwMBMYIOKTCCDiUG
// SIG // CSqGSIb3DQEHAqCCDhYwgg4SAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDwYLKoZIhvcNAQkQAQSggf8EgfwwgfkCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIJmX
// SIG // /gpX90Z+Kv9CYpgumB0wgbpNXdITIv4HDvVCHb3oAhUA
// SIG // hgRZlByFZFPMoHvglyPIQCVzumYYDzIwMTkxMTEyMTg0
// SIG // MzU5WjADAgEeoIGGpIGDMIGAMQswCQYDVQQGEwJVUzEd
...
// SIG // MTg0MzU5WjAvBgkqhkiG9w0BCQQxIgQgUzUoJ7AFT+Kz
// SIG // lKQrpLrD3C/ix7uMvCya+PvSJWXHDwAwNwYLKoZIhvcN
// SIG // AQkQAi8xKDAmMCQwIgQgxHTOdgB9AjlODaXk3nwUxoD5
// SIG // 4oIBPP72U+9dtx/fYfgwCwYJKoZIhvcNAQEBBIIBACja
// SIG // tvNiqzL42ULUr6gM87Q6lab0Rh2V5GeSK/SlIFv/FQge
// SIG // FeAqeqqTCBZ5R7lk637xpKWDUGV1qP579avt6Ycoo3Pc
// SIG // Avhf0i3wsVm1mhnyWo8ftUnrFsys8Iz71Ka+kkJGaoLc
// SIG // WfsYsuubDt18c5gxVaJ6FP33H25tpy3+l5tA2la10JUm
// SIG // AlokgBzs5AxrbS6gysieBawt7JndZzqWGbxrwhIs7vtK
// SIG // nq4d90DN4PEQKP26PGD0SgO6zN5dzEbL9QFzCwVMhhGG
// SIG // pANOc/HXxjwVXBUeb2sxEagdmj3UFUckBLM3QOn4zUed
// SIG // eeUxjNbmQHz33LjPBbhLkP1iTxNubNw=
