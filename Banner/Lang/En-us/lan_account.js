var lan_account = {
	"tag_1_txt": "My Profile",
	"tag_2_txt":"My Creative Assests",
	"tag_3_txt" : "My Plan",
	"account-login-out": "Log Out",
	"greeting_txt": "Hello, ",
	"account_title_email": "Email",
	"edit_btn": "Manage Account Online",
	"account_title_membership":"Subscription",
	"MEMBERSHIP_PRO_TRIAL": "SketchBook Pro Subscription (Trial)",
	"MEMBERSHIP_PRO_CAMPAIGN": "SketchBook Pro Subscription (Campaign)",
	"MEMBERSHIP_PRO": "SketchBook Pro Subscription",
	"MEMBERSHIP_FREE": "FREE",
	"MEMBERSHIP_PRO_MONTH": "SketchBook Pro Subscription (Monthly)",
	"MEMBERSHIP_PRO_YEAR": "SketchBook Pro Subscription (Yearly)",
	"MEMBERSHIP_PRO_QUARTERLY": "SketchBook Pro Subscription (Quarterly)",
	"account_title_validatedate": "Valid Through",
	"account_intro_free_id": "FREE: Access to basic tools for quick sketches.",
	"free_feature_list_1":"Optimized pen-based workflow",
	"free_feature_list_2":"16 brushes" ,
	"free_feature_list_3":"3 layers",
	"free_feature_list_4":"Rulers and ellipses",
	"free_feature_list_5":"Quick Transform",
	"left_current_plan": "Current Plan",
	"account_intro_pro_id":"PRO: Get the complete SketchBook experience across all your favorite devices.",
	"pro_feature_list_1":"100+ customizable brushes",
	"pro_feature_list_2":"Advanced layer functionality",
	"pro_feature_list_3":"Full set of Copic colors",
	"pro_feature_list_4":"FlipBook animation",
	"pro_feature_list_5":"Advanced perspective guides",
	"pro_feature_list_6":"Persistent selection tools",
	"pro_feature_list_7":"Distort transform",
	"pro_feature_list_8":"Dynamic Gradient Fill",
	"pro_feature_list_9":"Unlock mobile and desktop",
	"pro_feature_list_10":"Unlimited upgrades",
	"account_learn_more":"Learn more",
	"right_current_plan": "Current Plan.",
	"account_expire_txt": "Valid Through",
	"account_activate_trial_btn_txt": "15 Days Trial",
	"account_activate_trial_btn_txt_0": "",
	"account_activate_trial_btn_txt_2": "Days Trial",
	"countdown_txt_part1_1": "Days left",
	"countdown_txt_part1_2": "Day left",
	"countdown_fortrial": "for trial",
	"account_price_cell_txt": "Buy",


	"trial_activated_header": "Trial Activated!",
	"trial_activated_failed_header":"Trial Not Activated!",
    // "trial_activated_txt":"Now, you can enjoy Pro subscription free for 15 days.",
	"trial_validated_success_txt_1": "Now, you can enjoy Pro subscription free for",
	"trial_validated_success_txt_2": "days.",
	"trial_not_activated_same_machine_txt":"This machine has already run the trial.",
	"trial_not_activated_expired_txt":"Your account's trial has expired.",
	"trial_not_activated_try_again_txt":"Please try again.",
	"ok_btn":"OK",

	"forjs_mo": " / mo",
	"forjs_yr": " / yr",

	"account_mas_trial_btn_txt": "7 Day Free Trial",
	"account_mas_buy_btn_txt": "Buy",


	//title
	"price-title-free": "Free",
	"price-title-pro": "Pro",

	//trial txt
	"account_countdown_txt_1": "Days left for trial",
	"account_countdown_txt_2": "Day left for trial",
}
...
// SIG // Gh/RdpodUgJwl04ej0pKNzmShN6s2OkeAxuwfMFh0xGg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgrjOTmy88
// SIG // mFdHMrNjXig7K5Z3VxT3tolX2Lookb/5mXwwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAGaUu0KFq0qNI2tuCDJKBgWPLKSbh
// SIG // ybs3jz4mPe80orAJRWaB6qUzyc0Lv7T5KdVj+Lh7vgb/
// SIG // OdL0on4wpaEiLJA7/SbqYJRmOLf+NZp9yLkfiChtaoBA
// SIG // kpuT/T6oQJe6A2dMNOnoO+1wX7hkgdklg+hrffUF5/Be
// SIG // N34KYaV3Tav6VfPJJ5p0LVbFvgz5ifaCxYxjwFG+Xn6o
// SIG // UFBfWAvq9V25z0j9VHHCUT1G666ZP4lrX1Om5o8b877s
// SIG // QFIJek0OvBuxCqeM3Zk6POLUsAwLP3+x1NLaJL7n+yA2
// SIG // swad/LjVOfou9mJ+FiCHW5M8Dk7+cIJv6NAw4fqXkfC/
// SIG // LPCn/KGCDHQwggxwBgorBgEEAYI3AwMBMYIMYDCCDFwG
// SIG // CSqGSIb3DQEHAqCCDE0wggxJAgEDMQ8wDQYJYIZIAWUD
// SIG // BAIBBQAwga8GCyqGSIb3DQEJEAEEoIGfBIGcMIGZAgEB
// SIG // BgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQg41n+
// SIG // oBmJba1FXWM+CDP1g1gFT6Fku0VNprF748G9EI4CFHcH
// SIG // NNzWQICQIBmSosazmx1zI9FdGA8yMDE5MTExMjE4NDMz
...
// SIG // MzJaMC8GCSqGSIb3DQEJBDEiBCDku6C519rfPH3uXbOo
// SIG // hIIKUHLg2/RL2QTiNTgJGqHOQzCBoAYLKoZIhvcNAQkQ
...
// SIG // ggEAoS3KILBspZ0eVuqNcvW5a57vThdORPcN1mj5TUbm
// SIG // rNZnQL/a+jW9cKCnZrPJzGy71PwdiORfees5E3ZtnDPv
// SIG // LNNFWpzOSk1DKXhKt/flfSctNis0DUcRKClY2WuTwOSp
// SIG // ndFwVVm/qvOlcWVBnJrWDcAAM9i6+rlLwAkBEf7D+yuX
// SIG // E1BkLD73CbFkBGFUxVXAhh9Pv1wj3F9/9XAX42iwTt3Y
// SIG // r+Ul+91K8i3ZtKG0ToIytu5FtkHdjZPjkoGYAuPdZmYu
// SIG // oiVfG7F633fEBA8qrhaF0TPhbZ83H4W5STu9keiAMED8
// SIG // GLTa2ei3mTXkY/G4h4KbnYlWDJX1WPZWOLjI/w==
