var lan_lockout = {
    "announcement_header": "<strong>SKETCHBOOK</strong> 이 이제",
    "announcement_middle": "무료입니다",
    "no_really": "믿기지 않으신다고요?",
    "announcement_footer": "Autodesk Account 계정만 있으면 됩니다",

    "create_account_button": "계정 작성",
    "login_button": "로그인",

    // "days_remaining_plural_txt": "아니면 계정 없이 <span id='remaining_days'>7</span> 일 동안 사용해 보세요",
    "days_remaining_plural_txt_1": "아니면 계정 없이",
    "days_remaining_plural_txt_2": "일 동안 사용해 보세요",
    "days_remaining_singular_txt": "아니면 계정 없이 1일 더 사용해 보세요",

    "start_now_link": "그리기 시작",

    // "enjoy_trial_header_plural_txt": "<strong>SketchBook</strong>을 계정 없이 7일 더 사용해 보세요",
    "enjoy_trial_header_plural_txt_1": "<strong>SketchBook</strong>을 계정 없이",
    "enjoy_trial_header_plural_txt_2": "일 더 사용해 보세요",
    "enjoy_trial_header_singular_txt": "<strong>SketchBook</strong>을 계정 없이 1일 더 사용해 보세요",

    "calendar_icon_header": "기간 남음",

    // "enjoy_trial_footer": "아니면 <a>무료 계정을 작성하세요</a>",
    "enjoy_trial_footer_label": "아니면",
    "enjoy_trial_footer_link": "무료 계정을 작성하세요"
};
...
// SIG // dIDoDZJroDg6K2iAn7EBTH9w0xOUcMXq6ML7vBuAyI2g
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgIcrXobHm
// SIG // tNdh294dMxtmF9pNNU17L1Wk3c6n1Ef615wwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAcCxv78wk+DHL6+7ooLX5ZlXIy9hb
// SIG // ZJnxClVMNj/8loZm80QXmLmDexgXtRVi88Bp6M8dUsLR
// SIG // GWgU7IlpOB1Z+QZVgygYHBJd4NXILMPdvLO8HtG3u7ZC
// SIG // VFvkembtN8XNWOBteINEZLsFFOXeR9Bx0mcHzZHgiLx4
// SIG // NQB6wQUjuq5+cskJSmXU3pJ4L/Lf2mnR2/Im8qzJdJa0
// SIG // plLPemsVrENpXRv818JBUuAywsbYmRiQlc6VV0NRUl22
// SIG // bp6WyUjLKGVvt++DPtGZCqFaeCIHu4lokE0VF7jzQ92v
// SIG // X/1/54VAVd6OWFHVwvdxQuEo6p1Bw+H3CkQr/sRk+HZY
// SIG // HQEoAaGCE20wghNpBgorBgEEAYI3AwMBMYITWTCCE1UG
// SIG // CSqGSIb3DQEHAqCCE0YwghNCAgEDMQ8wDQYJYIZIAWUD
// SIG // BAIBBQAwggEMBgsqhkiG9w0BCRABBKCB/ASB+TCB9gIB
// SIG // AQYKKwYBBAGyMQIBATAxMA0GCWCGSAFlAwQCAQUABCBu
// SIG // +oYiMXR0W+woHlpVYx1ZbS+JmnnTTH+BfGBSN1x2awIU
// SIG // JpGJ+QtUS3pJOyIK3V05AlxTRSIYDzIwMTkxMTEyMTg0
// SIG // NTE2WqCBiqSBhzCBhDELMAkGA1UEBhMCR0IxGzAZBgNV
...
// SIG // MTZaMC8GCSqGSIb3DQEJBDEiBCA3VrIrCKwxBLx48Z+f
// SIG // vwyrOaUIl5QYtpDYZc7CFtKAojCB7QYLKoZIhvcNAQkQ
...
// SIG // hkiG9w0BAQEFAASCAgBLKKwoYBo3ptEqfxiRNigJKSyC
// SIG // wwjJmwP5r6H9BUTOIRdEXaUBCOsFav0ZFlpsVLSgpnla
// SIG // +wNe8qV8qIi5ns7doMBgqltILxyYFKe8Y+43qegdYMSh
// SIG // w4mT8jp3qy5ttOXsbO9DugVtsu8lvHh1FPzyQR9hQMbo
// SIG // gzqcnw81FGbzysjsIsJxHDRo0zRsh08obqDBt4eKGfgC
// SIG // n3rPCmd3iGGu6rYL90+BzKmRoh4pY4fV8xqgp9LXg99f
// SIG // m4gUHHlntJuPBFttUse6EHLdQCbg1+56N5lcEDZSfsjk
// SIG // z+Lo3ecWuptO+RY1hQkzev7DzcWClWIVTdNdwnV9LQ/R
// SIG // GhJugxBlYlKpFRYuoo3jRGlpbuK2dZhfSTaYR7rbr8fg
// SIG // LT1le53L/WLs5lbX46LWm4sDB8B0FUL+lNdLmJZB5NIZ
// SIG // XsZcDsmgPimrv6ChrBthY5hcuALv3xxzjJbRslVWgVB9
// SIG // BB/3i9lA8wPEIaUYlfzxl4kbsb0pKN2YOI9rP4Tb1go+
// SIG // 7Q9woRnBpkOQ/nazJV6DhPzqUSGpgqTFOsPUU45L1wjf
// SIG // QVf+nu16FTEQhd/U34FnwVWB2IpVE4LzYAvnlkHxnemY
// SIG // i2rSSsZf/xm4KwCTa4okPLt0qB8/iUVOSTHPBSfrh4B/
// SIG // +o6qoKlxqNhiYrvz2w/cvyoUSNCtq4qnkU7Z8UYM6w==
