var lan_account = {
	...
	"tag_2_txt":"내 창의적인 자산",
	"tag_3_txt" : "내 플랜",
	"account-login-out": "로그아웃",
	"greeting_txt": "안녕하세요? ",
	"account_title_email": "전자 메일",
	"edit_btn": "온라인으로 계정 관리",
	"account_title_membership":"회원권",
	"MEMBERSHIP_PRO_TRIAL": "SketchBook Pro 회원권(평가판)",
	"MEMBERSHIP_PRO_CAMPAIGN": "SketchBook Pro 회원권(캠페인)",
	"MEMBERSHIP_PRO": "SketchBook Pro 회원권",
	"MEMBERSHIP_FREE": "무료",
	"MEMBERSHIP_PRO_MONTH": "SketchBook Pro 회원권(월간)",
	"MEMBERSHIP_PRO_YEAR": "SketchBook Pro 회원권(연간)",
	"MEMBERSHIP_PRO_QUARTERLY": "SketchBook Pro 회원권(분기별)",
	"account_title_validatedate": "유효한 관통",
	"account_intro_free_id": "무료: 빠른 스케치를 위한 기본 도구 제공",
	"free_feature_list_1":"최적화된 펜 기반 워크플로우",
	"free_feature_list_2":"16개의 브러시 " ,
	"free_feature_list_3":"3개의 도면층",
	"free_feature_list_4":"눈금자 및 타원",
	"free_feature_list_5":"빠른 변환",
	"left_current_plan": "현재 플랜",
	"account_intro_pro_id":"PRO: 자주 사용하는 모든 장치에서 완벽한 SketchBok 환경 사용 가능",
	"pro_feature_list_1":"100개 이상의 사용자화 가능한 브러시",
	"pro_feature_list_2":"고급 도면층 기능",
	"pro_feature_list_3":"Copic 색상의 전체 세트",
	"pro_feature_list_4":"플립북 애니메이션",
	"pro_feature_list_5":"고급 투시 가이드",
	"pro_feature_list_6":"영구 선택 도구",
	"pro_feature_list_7":"왜곡 변환",
	"pro_feature_list_8":"동적 그라데이션 채우기",
	"pro_feature_list_9":"모바일 및 데스크톱 잠금해제",
	"pro_feature_list_10":"무제한 업그레이드",
	"account_learn_more":"자세한 정보",
	"right_current_plan": "현재 플랜",
	"account_expire_txt": "유효한 관통",
	"account_activate_trial_btn_txt": "15일 평가판",
	"account_activate_trial_btn_txt_0": "",
	"account_activate_trial_btn_txt_2": "일 평가판",
	"countdown_txt_part1_1": "일 남음",
	"countdown_txt_part1_2": "일 남음",
	"countdown_fortrial": "평가판",
	"account_price_cell_txt": "구입",

	"trial_activated_header": "평가판이 활성화됨",
	"trial_activated_failed_header":"평가판이 활성화되지 않음",
	"trial_activated_txt":"이제 15일 동안 무료로 PRO 회원권을 사용할 수 있습니다.",
	"trial_validated_success_txt_1": "이제",
	"trial_validated_success_txt_2": "일 동안 무료로 PRO 회원권을 사용할 수 있습니다.",
	"trial_not_activated_same_machine_txt":"이 컴퓨터에 이미 평가판이 실행 중입니다.",
	"trial_not_activated_expired_txt":"계정의 평가판이 만료되었습니다.",
	"trial_not_activated_try_again_txt":"다시 시도하십시오.",
	"ok_btn":"확인",

	"forjs_mo": " / mo",
	"forjs_yr": " / yr",

	"account_mas_trial_btn_txt": "7일 무료 평가판",
	"account_mas_buy_btn_txt": "구입",
    ...
    //trial txt
    "account_countdown_txt_1": "일 평가 기간 남음",
    "account_countdown_txt_2": "일 평가 기간 남음",
}
...
// SIG // 9XG5nFs8JyG9uPN0MSs0Q4d47hCYfXbeoB0eaOfUlMCg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQ