var lan_subscription = {
    "about_subscription_title": "Sobre a assinatura",
    "about_subscription_10": "Quais são as vantagens de uma assinatura do SketchBook?",
    "about_subscription_11": "Acesse ferramentas avançadas no SketchBook. Obtenha todas as atualizações e novos recursos em todos os seus dispositivos. Criar um número ilimitado de cenas no SketchBook Motion.",
    "about_subscription_20": "Como acessar minha assinatura em outros dispositivos?",
    "about_subscription_21": "Efetue login usando o mesmo nome de usuário e senha da Autodesk que você usou ao comprar a assinatura.",
    "about_subscription_30": "Quando minha assinatura será renovada?",
    "about_subscription_31": "As assinaturas são renovadas automaticamente, a não ser que a renovação automática seja desativada pelo menos 24 horas antes do fim do período de assinatura atual.",
    "about_subscription_40": "Quando eu serei cobrado?",
    "about_subscription_41": "Sua conta será cobrada para a renovação dentro de 24 horas antes do fim do período de assinatura atual e indicará o custo da renovação.",
    "about_subscription_50": "Como posso cancelar minha assinatura?",
    "about_subscription_51": "Quando você tiver feito uma compra, gerencie sua assinatura, incluindo a renovação automática, usando as Configurações da conta.",
    "about_subscription_60": "Perderei meu trabalho quando eu cancelar a assinatura?",
    "about_subscription_61": "Não. Você ainda terá acesso a todos os seus arquivos e às ferramentas básicas gratuitas. Porém, esteja ciente de que a exclusão do aplicativo excluirá todos os seus arquivos.",
    "about_subscription_90": "Termos de serviço do A360",
    "about_subscription_91": "e",
    "about_subscription_92": "Declaração de privacidade da Autodesk",
	...
	"promotion_info_title_sale": "VENDA",
	...
	"promotion_daysleft": "<span style='color: #188dfb'>{0}</span> dias restantes",
	"promotion_dayleft": "<span style='color: #188dfb'>1</span> dia restante",

	"promotion_dropdown_extension_months": "+{0} meses",
	"promotion_dropdown_extension_month": "+1 mês",
}
...
// SIG // 03S1IfuBkSMUSLlKFjpSwUWbKiL3NTFGKL3tdNl3XZGg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgSDTdzFhk
// SIG // p0JRwd0W/5DQTLwnCa4Vg00y7LlZSKBeoT0wDQYJKoZI
// SIG // hvcNAQEBBQAEggEAdmkgu0uktRqkCb4J87SWJI/aZTEG
// SIG // rMc1RrIPyaIm54uzs0ZJg6k8SwG2N/CDFeMvxYErHkbK
// SIG // Skn3y1MNE2oNZmshw+Ainy5Kcr6qhtQn1SALpFqwryXg
// SIG // hvePK0pkGdRwif7O4oLVerHNGr56PuhjzWyF3b+fvizg
// SIG // paelQWWiFZk++PeT1TVayzHweqHcJWtc51YV3WCfz3BS
// SIG // 8PCeUQkHh7eojbeUd8kqP+WjUTVSRdLR1XAlYsfGsy9b
// SIG // mljb2N2kxHCNGB9XXV3fs9Ojf/HGFDdimvWcbLdQ04KW
// SIG // B73QhRqdLvZu1NixOT2FozPnahm+J0zOnEJRuVQ7OE1G
// SIG // LlXMiKGCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEINmF
// SIG // I6lq0pFt2nYkl+7LHTRPEq+HqZDylszFqAqhSqaTAhQh
// SIG // TafVsHNDwSU1gU6c4Hhp7jDrCRgPMjAxOTExMTIxODQz
// SIG // MzJaMAMCAR6ggYakgYMwgYAxCzAJBgNVBAYTAlVTMR0w
...
// SIG // ODQzMzJaMC8GCSqGSIb3DQEJBDEiBCDOfak0bE4kduEA
// SIG // NQctlsp2oE5kO41lHjNoFD7xEGTjZjA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEAAhQ5
// SIG // o0a7FSNwMV1Ah9q4fSj1ffN55zyNl6XgGz4p3GQx9W76
// SIG // AHHlxPZMQtDsjKg5RBzxMOZ+sk3RvHZnzwaRSB/g6XaD
// SIG // vAopELJRASZUeAhNKkD0Nxts6cMnvdYEmYDMHsh+KvJm
// SIG // taVzHvI7BteFQjPgLzsCZzleiSGYY5wiCfWM089CDeal
// SIG // 6A+gITZlc8kavD/eZuGm/ujlIUGM3u1r6poXtOZ75DRS
// SIG // V21pUMWnXJCTv2VrIiKOcL3e+Z/iIKytzj2yb8m3UQIg
// SIG // uW3cQPfSVEhqBBHOiUcyuJw2j7Qd405FAfzADFhyiGaj
// SIG // GKbX1T8RE0z13BBs/VxpRpir0bWyhA==
