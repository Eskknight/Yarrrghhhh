var lan_account = {
	"tag_1_txt": "Meu perfil",
	"tag_2_txt":"Meus recursos criativos",
	"tag_3_txt" : "Meu plano",
	"account-login-out": "Efetuar logout",
	"greeting_txt": "Olá, ",
	"account_title_email": "E-mail",
	"edit_btn": "Gerenciar conta on-line",
	"account_title_membership":"Assinatura",
	"MEMBERSHIP_PRO_TRIAL": "Assinatura Pro do SketchBook (versão de avaliação)",
	"MEMBERSHIP_PRO_CAMPAIGN": "Assinatura Pro do SketchBook (campanha)",
	"MEMBERSHIP_PRO": "Assinatura Pro do SketchBook",
	"MEMBERSHIP_FREE": "GRÁTIS",
	"MEMBERSHIP_PRO_MONTH": "Assinatura Pro do SketchBook (Mensal)",
	"MEMBERSHIP_PRO_YEAR": "Assinatura Pro do SketchBook (Anual)",
	"MEMBERSHIP_PRO_QUARTERLY": "Assinatura Pro do SketchBook (Trimestral)",
	"account_title_validatedate": "Válido até",
	"account_intro_free_id": "GRÁTIS: acesso às ferramentas básicas para esboços rápidos.",
	"free_feature_list_1":"Fluxo de trabalho baseado em caneta otimizado",
	"free_feature_list_2":"16 pincéis" ,
	"free_feature_list_3":"Três camadas",
	"free_feature_list_4":"Réguas e elipses",
	"free_feature_list_5":"Transformação rápida",
	"left_current_plan": "Plano atual",
	"account_intro_pro_id":"PRO: obtenha a experiência completa do SketchBook em todos os seus dispositivos favoritos.",
	"pro_feature_list_1":"Mais de 100 pincéis personalizáveis",
	"pro_feature_list_2":"Funcionalidade de camada avançada",
	"pro_feature_list_3":"Conjunto completo de cores da Copic",
	"pro_feature_list_4":"Animação de FlipBook",
	"pro_feature_list_5":"Guias de perspectiva avançados",
	"pro_feature_list_6":"Ferramentas de seleção persistente",
	"pro_feature_list_7":"Distorção de transformação",
	"pro_feature_list_8":"Preenchimento de gradiente dinâmico",
	"pro_feature_list_9":"Desbloquear dispositivos móveis e desktop",
	"pro_feature_list_10":"Atualizações ilimitadas",
	"account_learn_more":"Saiba mais",
	"right_current_plan": "Plano atual",
	"account_expire_txt": "Válido até",
	"account_activate_trial_btn_txt": "Versão de avaliação de 15 dias",
	"account_activate_trial_btn_txt_0": "Versão de avaliação de",
	"account_activate_trial_btn_txt_2": "dias",
	"countdown_txt_part1_1": "Dias restantes",
	"countdown_txt_part1_2": "Dia restante",
	"countdown_fortrial": "para a versão de avaliação",
	"account_price_cell_txt": "Comprar",

	"trial_activated_header": "Versão de avaliação ativada!",
	"trial_activated_failed_header":"Versão de avaliação não ativada!",
	"trial_activated_txt":"Agora, você pode aproveitar uma assinatura PRO grátis por 15 dias.",
	"trial_validated_success_txt_1": "Agora, você pode aproveitar uma assinatura PRO grátis por",
	"trial_validated_success_txt_2": "dias.",
	"trial_not_activated_same_machine_txt":"Esta máquina já executou a versão de avaliação.",
	"trial_not_activated_expired_txt":"A versão de avaliação de sua conta expirou.",
	"trial_not_activated_try_again_txt":"Tente novamente.",
	"ok_btn":"OK",

	"forjs_mo": " / mês",
	"forjs_yr": " / ano",

	"account_mas_trial_btn_txt": "Avaliação gratuita de 7 dias",
	"account_mas_buy_btn_txt": "Comprar",

    //title
    "price-title-free": "Grátis",
    "price-title-pro": "Pro",

    //trial txt
    "account_countdown_txt_1": "dias restantes para a avaliação",
    "account_countdown_txt_2": "dia restante para a avaliação",
}
...
// SIG // DGZuxjoNor/R4dJ3yT1nuZsiCwVtRObfR2vJ7WMNq0Cg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQga5MzHBUu
// SIG // +392/JMzipT2LINN2XM9J7zzzayqZkM/65wwDQYJKoZI
// SIG // hvcNAQEBBQAEggEABxVZ3om7a8T6lCs26NOzVvbMTEWx
// SIG // 64Nj098qYTNMkTG7nY35HrvZo9qJ6sb4hJNoKKSSq1Hg
// SIG // 8FoyPP86R6ngUjZTO3qxTAAWvBjchd5JhEJGCmofnXkg
// SIG // +KJFU9wRtZ2Yiwv7gF7w2I8jbImSP/Hu3tkzsd/86d/f
// SIG // hOdYS1JZkqgpm0LtH0vfEsKn+urKOhR0oDKAYehEwRPh
// SIG // a7SAdNFOtekoCjBgNP49j2fUCRo8tNX/7L4h1oCCI/f5
// SIG // EWlVubNv0tOQzzHLjmdhGLvUtq8F/bguXPM09/VQluZU
// SIG // PZB5JTZpcKHDQvJyR+8D96HYKrp2HjZOw4Tko0V/ClNN
// SIG // 34WvXaGCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIDFG
// SIG // lqF98hyPHRkm6k93qtYEt8afZgc/FUyzcKIL2MszAhQi
// SIG // v4djt6REb8Ta+GyWMk36YrTl9RgPMjAxOTExMTIxODQz
...
// SIG // ODQzMzZaMC8GCSqGSIb3DQEJBDEiBCBgw/r1qELQ+2vc
// SIG // k38mjFShILFuL7npEa8mxJ60v0coWTA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEAm/Oh
// SIG // GqsaVieAut2JscqtQAV9Hv/u3JrNLFZQd/mcE238pVza
// SIG // 5T/NoC75iXidSVoCfvzZ6CCUp/soEU/jGChokpmDT75O
// SIG // 3a8wZqNOF0uW/a7ytjGDJGMoLVc2FXNBNlP7gtHZOH2E
// SIG // LsnZwlEZx4kIwPFFirH0fwurqlxxnPthQzSP+aBu1PiO
// SIG // 1JzI73xFllGdqJv4u5e3zHouXofbMQ8heXeP/76sB8Ts
// SIG // SOgoNVCGl6ZRX/7B5tRv+tetYQUz5aRdfJnfhHdBCLNV
// SIG // juDLc1KRMeF3AhADB+BVlLZdRFavmpRCHc1MUHQ4v6Gp
// SIG // P+TkBFSv6IjN3KtCUQGTSYz3SmRSug==
