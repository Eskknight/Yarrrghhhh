var lan_campaign_validated = {
	"campaign_validated_success_header": "おめでとうございます!",
	"campaign_validated_failed_header": "アクティベーションに失敗しました",
	"campaign_validated_failed_involved_header": "アクティベーションに失敗しました",
	"campaign_validated_failed_error_header": "エラーが発生しました",
	// "campaign_validated_success_txt": "Enjoy your Pro membership for <span id='campaign_days'>30</span> days.",
	"campaign_validated_success_txt_1": "Pro メンバーシップを",
	"campaign_validated_success_txt_2": "日間お楽しみください。",
	"campaign_validated_success_singular_txt_1": "Pro メンバーシップを",
	"campaign_validated_success_singular_txt_2": "日間お楽しみください。",
	// "campaign_validated_success_singular_txt": "Enjoy your Pro membership for <span id='campaign_day'>1</span> day.",
	"campaign_validated_invalid_txt": "このキャンペーンの有効期限が切れています。",
	"campaign_validated_consumed_txt": "Pro メンバーシップの体験版をすでに持っているため、このキャンペーンは</br>使用できません。",
	"campaign_validated_maxtimes_txt": "このキャンペーンは終了しています。",
	"campaign_validated_client_error_txt": "もう一度試してください。",
	"campaign_validated_unknown_txt": "もう一度試してください。",
	"ok_btn": "OK"
}
...
// SIG // P7YwcundhockNE4RhzOxL/fdh6fHvRXwnPvX+St+kMyg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgf0fyHkLX
// SIG // 7rR57JPmO4w7mgsU8jhKVg4CeqJyHCWn6MYwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAifJx02LP/n51i7opBH84vfJNLUsn
// SIG // UAxUcDfn8AvNytJQUdjoEKqqDqV5/81pkOjzeSgWOcPu
// SIG // xm/2WjH6GSZXZKFRwEx0Ya5Yj5ubhgRFMbRl3oWtPBqn
// SIG // dxYD6OQAVZiTUpH0MHrntd/9ZixzWhbjDqODsaC4rW1e
// SIG // akxub+C86fKsAT0sq8Y0ILTrAjwdVc3RSDf7qmc6Cwdq
// SIG // 9Vu60MZiufPlEpesIDInMAinI7K5LMK3S93TDPYz52HW
// SIG // xwthj4MJVZFO4e8M/Cn4UVLXZ3RvvePuNluVYXrBTj5C
// SIG // QGtO+r69MNd/UUf1Fj43h+0Ye5b+QLGY3JzE3ofpH6U7
// SIG // 9UKHO6GCDj0wgg45BgorBgEEAYI3AwMBMYIOKTCCDiUG
// SIG // CSqGSIb3DQEHAqCCDhYwgg4SAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDwYLKoZIhvcNAQkQAQSggf8EgfwwgfkCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEII2b
// SIG // dtDavRWkEnrzRIaK5/p8Zqzuf1kCu4aS+TrffJVwAhUA
// SIG // h9TEARQxrpyJ2xD8pFyBASeHywMYDzIwMTkxMTEyMTg0
// SIG // MzQ2WjADAgEeoIGGpIGDMIGAMQswCQYDVQQGEwJVUzEd
...
// SIG // MTg0MzQ2WjAvBgkqhkiG9w0BCQQxIgQgNECeF5XAuA6l
// SIG // uNY1x2rhO614Fuuddq1A7IEIVxNxtg8wNwYLKoZIhvcN
// SIG // AQkQAi8xKDAmMCQwIgQgxHTOdgB9AjlODaXk3nwUxoD5
// SIG // 4oIBPP72U+9dtx/fYfgwCwYJKoZIhvcNAQEBBIIBAHB8
// SIG // bJEKpn05KaM6UiRxj50sIpDzLzKfiIMeZcnRf9+PNOBS
// SIG // un2yWENVj5HffzUp8lDIpws5hAlM4O9OqdIN7unqAOOD
// SIG // nv346sphywpn3yDdp35JJ/M74lFMk5JQVusqgvF5xoQ8
// SIG // 3aivowQjsqzsG50B0kjd+Pa3SEIsGMIra25jJBdIJugR
// SIG // rutPXRYP+h3P68SwyD9FRrneTv5mW6GHAjb7qfjtsjqp
// SIG // 1sbjMIC6BtvcfbjAxfv+/X05MZxzWDYCgtxL16uQI1le
// SIG // s1TrJwhaMfvpyIo2IGRajmKk55gt6CcUVsAzVXlakFyV
// SIG // D9O3HUXMr3W8xyBh9unmLyD2ls6I7s8=
