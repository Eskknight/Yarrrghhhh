var lan_lockout = {
    "announcement_header": "<strong>SKETCHBOOK</strong> を",
    "announcement_middle": "無償",
    "no_really": "でご利用いただけます!",
    "announcement_footer": "Autodesk Account があればすぐに使用できます",

    "create_account_button": "アカウントを作成",
    "login_button": "サインイン",

    // "days_remaining_plural_txt": "または、アカウントなしで  <span id='remaining_days'>7</span> 日間の試用ができます",
    "days_remaining_plural_txt_1": "または、アカウントなしで、あと ",
    "days_remaining_plural_txt_2": "日の試用ができます",
    "days_remaining_singular_txt": "または、アカウントなしで、あと 1 日の試用ができます",

    "start_now_link": "描画を開始",

    // "enjoy_trial_header_plural_txt": "アカウントなしで <strong>SketchBook</strong>  を 7 日間お使いいただけます",
    "enjoy_trial_header_plural_txt_1": "アカウントなしで <strong>SketchBook</strong> をあと",
    "enjoy_trial_header_plural_txt_2": "日間お使いいただけます",
    "enjoy_trial_header_singular_txt": "アカウントなしで <strong>SketchBook</strong> をあと 1 日お使いいただけます",

    "calendar_icon_header": "残り日数",

    // "enjoy_trial_footer": "または... <a>無償アカウントを作成</a>",
    "enjoy_trial_footer_label": "または...",
    "enjoy_trial_footer_link": "無償アカウントを作成"
};
...
// SIG // iesOFWAtJ0p6/HNiT3daVvnpmWC2d1RBP8xrFPGn1Bug
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgN6MFwBMv
// SIG // uZzXMUspk9FjHYhrthWr5SxWSgkFLqLUJX4wDQYJKoZI
// SIG // hvcNAQEBBQAEggEAhuhRiZaVSNU1fXZyMaucxISt9+O0
// SIG // wQQ7LoM2vKaCDHNDRGcre3KN9TRnPpNmqKDDgUUIv1ij
// SIG // BOcQ8D9+kiNyCVCAQWIhWZwA03Wm/51QnYEeya2F+sbi
// SIG // mKG3gih/dRReT9S5SxGCFdazUZBrEoUQ50Y2GM9GB9ZU
// SIG // /dTT9wvCAq6kAhp2bSangJ7UosF6Sk7kaECkmQT6HZuA
// SIG // ohv0kUc8+WbeTN+t/uaYWzvw4gxu5N2pVGhV1UKljxNg
// SIG // X5rSiczDsSELP5HCvVb66ylBEupjpGMWYVdBm+zZvTYN
// SIG // vdaK0tv913mFtEyEyNssLNUzXqHiyihJoIwMve38laEi
// SIG // ao3K7qGCDHQwggxwBgorBgEEAYI3AwMBMYIMYDCCDFwG
// SIG // CSqGSIb3DQEHAqCCDE0wggxJAgEDMQ8wDQYJYIZIAWUD
// SIG // BAIBBQAwga8GCyqGSIb3DQEJEAEEoIGfBIGcMIGZAgEB
// SIG // BgkrBgEEAaAyAgMwMTANBglghkgBZQMEAgEFAAQgfCaz
// SIG // GjRqLfIXojPV0KhElpm0gVAuSVmHlGwppMXxUV8CFHAJ
// SIG // Xr6RsoGGif5JA76kDXd/nf99GA8yMDE5MTExMjE4NDQy
...
// SIG // MjBaMC8GCSqGSIb3DQEJBDEiBCD+tR9HQRFJEmNl2mog
// SIG // wPm5/aNrCwcvc3m5elj25Y026zCBoAYLKoZIhvcNAQkQ
...
// SIG // ggEAki/HE4LAE9opEzWsj1BRgc3/RiJGnaSbjsay0v2C
// SIG // xhiirp+qNaGuPm//3k4qi6tcoT/GIWsgsdWHqAX2Gr77
// SIG // bSV0k/5w2CgHgDwNjVHYiEv0OaVVUhHs3wYdqY7I7lke
// SIG // HB3TNTRMA5eidUXyWC/fQD0iozjfY6XM7Qeo0UDlkNgU
// SIG // 7iNTK72m94gY3WcmFZgSubDTbQkPf5dEenZLtwa+lfAB
// SIG // YXbbTtbh9Gw69s/iIkdRnb9UQD1vCT6RAv4mJw/fvF6J
// SIG // K+3mEbt5ZqlOcJ80CPR9OPYoZYtIBPP+/CJX3WMuqggt
// SIG // H4vxrLldXQECaSFT2dxWyMpp1ToVqWHj5O2cbQ==
