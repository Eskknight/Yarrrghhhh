var lan_account = {
	"tag_1_txt": "マイ プロファイル",
	"tag_2_txt":"マイ クリエイティブ アセット",
	"tag_3_txt" : "マイ プラン",
	"account-login-out": "ログアウト",
	"greeting_txt": "こんにちは、 ",
	"account_title_email": "電子メール",
	"edit_btn": "オンラインでアカウントを管理",
	"account_title_membership":"メンバーシップ",
	"MEMBERSHIP_PRO_TRIAL": "SketchBook Pro メンバーシップ(体験版)",
	"MEMBERSHIP_PRO_CAMPAIGN": "SketchBook Pro メンバーシップ(キャンペーン版)",
	"MEMBERSHIP_PRO": "SketchBook Pro メンバーシップ",
	"MEMBERSHIP_FREE": "フリー",
	"MEMBERSHIP_PRO_MONTH": "SketchBook Pro メンバーシップ(1 ヵ月)",
	"MEMBERSHIP_PRO_YEAR": "SketchBook Pro メンバーシップ(1 年間)",
	"MEMBERSHIP_PRO_QUARTERLY": "SketchBook Pro メンバーシップ(3 ヵ月)",
	"account_title_validatedate": "有効化の手段",
	"account_intro_free_id": "フリー: すばやくスケッチするための基本ツールにアクセスできます",
	"free_feature_list_1":"最適化されたペンベースのワークフロー",
	"free_feature_list_2":"16 本のブラシ " ,
	"free_feature_list_3":"3 つのレイヤ",
	"free_feature_list_4":"ルーラーと楕円",
	"free_feature_list_5":"クイック変換",
	"left_current_plan": "現在のプラン",
	"account_intro_pro_id":"Pro: お気に入りのすべてのデバイスで SketchBook を完全に利用できます",
	"pro_feature_list_1":"100 本以上の カスタマイズ可能なブラシ",
	"pro_feature_list_2":"高度なレイヤ機能",
	"pro_feature_list_3":"Copic カラーの完全なセット",
	"pro_feature_list_4":"フリップブック アニメーション",
	"pro_feature_list_5":"高度なパース ガイド",
	"pro_feature_list_6":"永続的な選択ツール",
	"pro_feature_list_7":"歪み変換",
	"pro_feature_list_8":"ダイナミック グラデーション塗りつぶし",
	"pro_feature_list_9":"モバイルおよびデスクトップを利用可能",
	"pro_feature_list_10":"無制限のアップグレード",
	"account_learn_more":"詳細情報",
	"right_current_plan": "現在のプラン",
	"account_expire_txt": "有効化の手段",
	"account_activate_trial_btn_txt": "15 日間の製品体験版",
	"account_activate_trial_btn_txt_0": "",
	"account_activate_trial_btn_txt_2": "日間の製品体験版",
	"countdown_txt_part1_1": "日で試用",
	"countdown_txt_part1_2": "日で試用",
	"countdown_fortrial": "期間終了",
	"account_price_cell_txt": "購入",

	"trial_activated_header": "体験版がアクティブです!",
	"trial_activated_failed_header":"製品体験版がアクティブでありません!",
	"trial_activated_txt":"これで、Pro メンバーシップは、15 日間無償で利用できます。",
	"trial_validated_success_txt_1": "これで、Pro メンバーシップは、",
	"trial_validated_success_txt_2": "日間無償で利用できます。",
	"trial_not_activated_same_machine_txt":"このコンピュータではすでに体験版が実行されています。",
	"trial_not_activated_expired_txt":"アカウントの体験版の有効期限が切れています。",
	"trial_not_activated_try_again_txt":"もう一度試してください。",
	"ok_btn":"OK",

	"forjs_mo": " /月",
	"forjs_yr": " /年",

	"account_mas_trial_btn_txt": "7 日間の無償体験版",
	"account_mas_buy_btn_txt": "購入",
    ...
    //trial txt
    "account_countdown_txt_1": "日間 - 体験版の残り日数",
    "account_countdown_txt_2": "日間 - 体験版の残り日数",
}
...
// SIG // EEQBxutEXM4ATIWk+ZSOV/j6MAPw4/ITE6jxUm4U7lWg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQ