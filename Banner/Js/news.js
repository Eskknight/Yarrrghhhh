// START_JS_FOR_NEWS -------------
// Dependent: urlParseModule.js
$(document).ready(function(){    
    displayNews();
});

function displayNews(){
    var newsurl = urlParseModule.getURLParameter('news');
    if(newsurl){
        $("#content_3").append("<iframe class='newsframe' frameBorder='0' scrolling='no' src='" + newsurl + "'></iframe>");
        if($("#tag_3").hasClass('mhidden')){
            $("#tag_3").removeClass('mhidden');
        }
        if($("#content_3").hasClass('mhidden')){
            $("#content_3").removeClass('mhidden');
        }
    }else{
        if(!$("#tag_3").hasClass('mhidden')){
            $("#tag_3").addClass('mhidden');
        }
        if(!$("#content_3").hasClass('mhidden')){
            $("#content_3").addClass('mhidden');
        }
    }
}
...
// SIG // 0F4RIPtupBz9sbccoWzK1adJ+iOiXLqnZgJzzs+ehAyg
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg7L4Hfyxe
// SIG // eChTdE1rTNYrysR/93H02FCpMNcmp7SseVAwDQYJKoZI
// SIG // hvcNAQEBBQAEggEADN5XbN9L/2GgbDo/IGBWpx340d7c
// SIG // BMbeOMtvNRBQbb0I7rC1rjheOKWTz1IhQJul5AbVwY4i
// SIG // MGfN6XxEy9Zkx90Ey7K0x6lkRUlrwnKVF5CxZwlg9CDs
// SIG // 95gYBMGY0lMwW+PFB58QIsBdMbrq5Mmx/FhBUCEm/E9q
// SIG // wYpUFIqtowMeFkc+lgr99liHZVQyO67MpYEb0wneS0VU
// SIG // FcmwKuxyhhMeCxlUap6A6qPKTWODN6KAoV236de5aOml
// SIG // gTO9gtA+B1y7PE3dax56I60IEfug8NPAqBOtPkUSXj9m
// SIG // HZtvGOegWrZ8XA72vjV0Bs2HLmmQnDEjwF4wXu3D/hWu
// SIG // 4yhG3aGCDjwwgg44BgorBgEEAYI3AwMBMYIOKDCCDiQG
// SIG // CSqGSIb3DQEHAqCCDhUwgg4RAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDgYLKoZIhvcNAQkQAQSggf4EgfswgfgCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIGR5
// SIG // XfRVFUz3WnjE4mCmuQQa7xbc7iJvh8kzcyFttsg9AhRj
// SIG // oooMpyYCsjQMSA7iZqNjgFO4/BgPMjAxOTExMTIxODQz
...
// SIG // ODQzNDRaMC8GCSqGSIb3DQEJBDEiBCDTBnVrZpndVyXS
// SIG // YHimWyivSQpKHpgbuPSAxwBrNS7qiTA3BgsqhkiG9w0B
// SIG // CRACLzEoMCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPni
// SIG // ggE8/vZT7123H99h+DALBgkqhkiG9w0BAQEEggEASoip
// SIG // Mt2P63uctzoOa7TVJODYp0Q7ODBNkAbsGjMOqDiKwdZO
// SIG // UaA5EF7lbtYVk7a2t0SawR2+Gf2secmy3cjbbSQ6YndI
// SIG // ZeRtjiw+yFQmaf048DIhOzJTDUElJuPEjUwQuUjekd6f
// SIG // zq9PXaAyWSLayVF4vkJpOetGbX9dOgLHlgfXUamqktLA
// SIG // HNaPjve9q3aY32R5i809uUuRfGxMkiVHo9y8wAxlTQ/D
// SIG // l8AZETkwubsx3ShnEhUhtSBqhfGcTLFh0Yi7YJSroo4F
// SIG // C1xMXflPl84Zctlgr/WMQa5t0mv+tVo9QOo2k1KXuwZh
// SIG // BtyMXdu7vqwOvxswIxgkoiosEMpPpw==
