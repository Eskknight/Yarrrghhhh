var imageProcessModule = (function(){
	var myScaleImage = function(srcwidth, srcheight, targetwidth, targetheight)
	{
	    ...
	    var ratioSrc = srcheight/srcwidth;
	    var ratioTar = targetheight/targetwidth;
	    ...
	    if(srcwidth <= targetwidth)
	    {
	        ...
	        {
	            result.width = targetheight / ratioSrc;
	    ...
	    else
	    {
	        if(srcheight<=targetheight)
	        {
	            ...
	            result.height = targetwidth * ratioSrc;
	        }
	        else
	        {
	            if(ratioSrc < ratioTar)
	            {
	                result.width = targetwidth;
	                result.height = targetwidth * ratioSrc
	            }
	            else if(ratioSrc > ratioTar)
	            {
	                result.height = targetheight;
	                result.width = targetheight / ratioSrc;
	            }
	...
	return {
		scaleImage: function(srcwidth, srcheight, targetwidth, targetheight){
			return myScaleImage(srcwidth, srcheight, targetwidth, targetheight);
		}
	};
...
// SIG // EYUcQw93kFDi3AqZhcm6VCzDtRnv+3GojAN2DwrXtPug
...
// SIG // KwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgJ4GYgCJk
// SIG // U4yy8rTMdVX0adwqNjYMT9lSeQL0iuEMv4gwDQYJKoZI
// SIG // hvcNAQEBBQAEggEAaBye2v8KtEE8j7jiX1Nn+BmKxXd5
// SIG // BRpy15pA3DZl3sB4kHfTEVUsT+zurlVbO5M/eDbp9Wk2
// SIG // 91iMKtoholwy6jSRYBC//15Cum7y2+RH4QdwYMkv8LS/
// SIG // lvPsiXvynfCBc3n+XWOPm2Ydb1hnuck4WjBwooVW2JIY
// SIG // E8dxOazgiVBXW3xyQlD7An+JeM8B1KWFhcgnbIldp/55
// SIG // nU5IlAo/ebN7mAnz1EDZEFpC5TUL+z+5nRbacQgUBV19
// SIG // 4+f+Hj6WOMPBLOMlIReE3Y73fG9nPocmV+M6HC3viS2K
// SIG // tdcURokzqiNrCbTkJ9i5feuXoo1eqK/T0CvorsFwBF8n
// SIG // 6KODyqGCDj0wgg45BgorBgEEAYI3AwMBMYIOKTCCDiUG
// SIG // CSqGSIb3DQEHAqCCDhYwgg4SAgEDMQ0wCwYJYIZIAWUD
// SIG // BAIBMIIBDwYLKoZIhvcNAQkQAQSggf8EgfwwgfkCAQEG
// SIG // C2CGSAGG+EUBBxcDMDEwDQYJYIZIAWUDBAIBBQAEIJNn
// SIG // MVr89VgAFBTQECbplxmLx5rfaIaLMCiZ9BbbXxqqAhUA
// SIG // q/YOVA1Kvm48t+e25nmy8ktjdYUYDzIwMTkxMTEyMTg0
// SIG // MzQzWjADAgEeoIGGpIGDMIGAMQswCQYDVQQGEwJVUzEd
...
// SIG // MTg0MzQzWjAvBgkqhkiG9w0BCQQxIgQgOmQZn8D+p6QD
// SIG // DnzZTpX7LbjIhbmfm3O88P/rAiQq28YwNwYLKoZIhvcN
// SIG // AQkQAi8xKDAmMCQwIgQgxHTOdgB9AjlODaXk3nwUxoD5
// SIG // 4oIBPP72U+9dtx/fYfgwCwYJKoZIhvcNAQEBBIIBABUS
// SIG // h0aAvYoZWcWUjRfa9VGYDsEXPxtGte7PMSmbU0AhANIC
// SIG // kvchxFy59yVDT0XPzB/20rbqZFqDJKc9FJ3UnT+hHtmg
// SIG // OYJjSxbZaONeT5oxHMlz+TGvbJwvCzUBQXlRh3kw93YP
// SIG // CtCKRypSj/2nXydkEdnLKlRNAa/c84+s3C7dcBvZBFLj
// SIG // pnDvvRYpq/X3SzTtKJ1ozQwgSvMxfEL9egidCiyLA33C
// SIG // K9o62b4heQcjOdOwQa4wOgXlBJ6rTEsE9VoC2T8A+pdu
// SIG // +Efelx8rmkiWwyoGiJj0B+H0pZENiAoZ89XBS2OiQIJq
// SIG // dBkAyhPOrIT2rh+/F8Ac+2aEWChYuV0=
